...
elseif(APPLE)
  ...
  set(TOOLCHAIN_DIR "/home/happycpu/SimplicityStudio_v5/developer/toolchains/gnu_arm/12.2.rel1_2023.7//bin/")
endif()
...
elseif(APPLE)
  ...
  set(POST_BUILD_EXE "/home/happycpu/SimplicityStudio_v5/developer/adapter_packs/commander/commander")
endif()
...
elseif(APPLE)
  ...
  set(NINJA_RUNTIME_PATH "/home/happycpu/SimplicityStudio_v5/developer/adapter_packs/ninja/ninja")
endif()
